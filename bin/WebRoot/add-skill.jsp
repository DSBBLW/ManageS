								...
								<ul>
									<li class="submenu">
										...
										<ul>
											...
											<!-- 添加业务 --><li><a href="add-skill.jsp" class="active"><span>添加业务</span></a></li>
										</ul>
									</li>
									<li>
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form id="qw"  method="post" action="/ManageS/addBill">
										<div class="row">
											<div class="col-12">
											...
											<div class="col-12 col-sm-6">  
												<div class="form-group">
													<label>处理人</label>
													<input name="conductor" type="text" id="text1" class="form-control" >
												</div>
											</div>
											...
											<div class="col-12 col-sm-6">  
												<div class="form-group">
													<label>业务</label>
													<input name="business" type="text" id="text2" class="form-control" >
												</div>
											</div>
											<div class="col-12 col-sm-6">  
												<div class="form-group">
													<label>费用</label>
													<input name="price" type="text" id="text3" class="form-control">
												</div>
											</div>
											<div class="col-12 col-sm-6">  
												<div class="form-group">
													<label>备注</label>
													<input name="remark" type="text" id="text4" class="form-control">
												</div>
											</div>
