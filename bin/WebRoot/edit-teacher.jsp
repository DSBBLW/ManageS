						...
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<!-- 编辑教师 --><li><a href="edit-teacher.jsp" class="active">编辑教师</a></li>
								</ul>
							</li>
							<li class="submenu">
									...
									<form>
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>姓名</label>
													<input type="text" class="form-control" value="${list.thname }">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>薪资</label>
													<input type="text" class="form-control" value="${list.money}">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>手机号</label>
													<input type="text" class="form-control" value="${list.phonenum}">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>部门</label>
													<input class="form-control" type="text" value="${list.post}">
												</div>
											</div>
											<!-- <div class="col-12">
