    		...
    		function start(){
    			...
    			success:function(data){
    				var list="";
  					...
  					list+="<td>< a href=' ' class='btn btn-sm bg-success-light mr-2'><i class='fas fa-pen'></i></ a><a  onclick='deletel("+item.id+");' class='btn btn-sm bg-danger-light'><i class='fas fa-trash'></i></ a></td></tr>";
  					$("#table").html(list);
  				});
    			}
    			});
