	 ...
	 <script type="text/javascript">
        			...
        			var aaa="";
      				...
      				var str="";
       					...
       					str+="<a onclick='getXia("+num+")' class='btn btn-outline-primary mr-2'>下一页</a>";
       					str+="<a onclick='getWy("+num+")' class='btn btn-outline-primary mr-2'>尾页</a>";
       					$("#paging").html(str);	
       				}
      			function upd(num){
						...
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<li>
										<!-- 团建 --><a href="expenses.jsp"  class="active"> <span>团建</span></a>
									</li>
								</ul>
							</li>
