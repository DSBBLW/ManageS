						...
						<ul>
							...
							<li class="submenu active">
								...
								<ul>
									...
									<li><a href="teacher-edit-student.jsp" class="active">编辑学生</a></li>
								</ul>
							</li>
									...
									<input type="text" class="form-control" style="display:none;" name="id" value="${list.id}">
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>班级</label>
													<input type="text" id="text3"  onchange="my();" class="form-control" name="classs"  value="${list.classs }">
											...
											<script type="text/javascript">
												...
												<div class="form-group">
													...
													<select name='idc' id="s2" class="form-control" onchange="show1();" style="display:none;">
