			...
			function all(bool,email,love){
				...
				success:function(data){
					...
					$(data).each(function(i,item){
       				...
       				if(item.love == 0){
       					aaa+="<td><span  class='mail-important'><i class='far fa-star'></i></span></td>";
       				}else{
       					aaa+="<td><span class='mail-important'><i class='fas fa-star starred'></i></span></td>";
       				}
					}); 
					aaa+="<td></td></tr>";
					$("#tab").html(aaa);
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="student-inbox.jsp">我的油箱</a>
							<a class="dropdown-item" href="login.jsp">退出账号</a>
						</div>
					</li>
					<!-- /User Menu -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-4">
							...
							<ul class="inbox-menu">
								...
								<li>
									<a href="#" onclick="bool();"><i class="far fa-star"></i>点击收藏</a>
								</li>
								<li>
