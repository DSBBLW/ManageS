                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form id="qw" method="get"  onsubmit="return checkForm(this);" action="addlo">
									...
									<div class="form-group">
										<input class="form-control" name="stid" type="text" id="text1" placeholder="学号或职工号" onchange="stu();">
									</div>
									<div class="form-group">
...
function checkForm(form) {
	...
	if(!$("#text3").val().match(a)){
	alert("密码至少8~16位，并包含数字和大写字母");
		return false;
	}
	return true;
}
