					...
					<div class="row">
						<div class="col-lg-3 col-md-4">
							...
							<ul class="inbox-menu">
								...
								<li>
									<a href="#"><i class="far fa-paper-plane"></i> 发邮件</a>
								</li>
										...
										<div class="row">
												...
												<div class="float-left">
													...
													<div class="btn-group dropdown-action">
														...
														<div class="dropdown-menu">
															...
															<div class="dropdown-divider"></div> 
															<a class="dropdown-item" href="#">标记为已读</a>
															<div class="dropdown-divider"></div> 
											...
											<div class="col-auto top-action-right">
												<div class="text-right">
													<button type="button" title="刷新" data-toggle="tooltip" class="btn btn-white d-none d-md-inline-block"><i class="fas fa-sync-alt"></i></button>
													<div class="btn-group">
