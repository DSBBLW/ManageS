                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="teacher-index.jsp"><i class="fas fa-th-large"></i> <span>指示板</span></a>
							</li>
							<li class="submenu">
							...
							<a href="teacher-subjects.jsp" class="active"><i class="fas fa-book-reader"></i> <span>专业列表</span> </a></li>
