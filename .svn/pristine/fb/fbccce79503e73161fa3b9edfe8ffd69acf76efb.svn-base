						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="student-details.jsp">学生观点</a></li>
							...
							<li class="submenu active">
								...
								<ul>
									<li><a href="teachers.jsp">教师名单</a></li>
									<li><a href="teacher-details.jsp" class="active">教师信息</a></li>
									<li><a href="add-teacher.jsp">教师添加</a></li>
									<li><a href="edit-teacher.jsp">教师编辑</a></li>
								</ul>
							</li>
							<li class="submenu">
